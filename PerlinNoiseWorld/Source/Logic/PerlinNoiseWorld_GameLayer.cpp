#include "PerlinNoiseWorld_GameLayer.h"
...
bool PerlinNoiseWorld_GameLayer::Init(const yang::ApplicationLayer& app)
{
...
void PerlinNoiseWorld_GameLayer::Update(float deltaSeconds)
{
